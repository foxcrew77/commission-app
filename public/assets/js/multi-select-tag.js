...
function MultiSelectTag(el, customs = { shadow: false, rounded: true }) {
    ...
    function init() {
        ...
        //onclick for open/close option
        var outer = document.getElementById('body');
    ...
    function createElements() {
        ...
        //set button type to button to avoid triggering submit when clicked
    ...
    function createElementInSelectList(option, val, selected = false) {
        ...
        if(option.value === 'driver'){
            const li = document.createElement('li');
            li.style.color = 'gray';
            li.style.marginTop = '4.5px';
            li.style.marginBottom = '4px';
            li.style.marginLeft = '8px';
            li.innerHTML = "<div style='cursor: not-allowed;'><span style='pointer-events: none;' class='separator'>Driver</span></div>";
            ul.appendChild(li);
        } else {
